    ...
    class Console : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (shakeToOpen &&
                ...
                Accelerometer.current.acceleration.ReadValue().sqrMagnitude > shakeAcceleration &&
                curTime - lastToggleTime >= toggleThresholdSeconds &&
                (!shakeRequiresTouch || UnityEngine.InputSystem.EnhancedTouch.Touch.activeTouches.Count > 2))
            {
                isVisible = !isVisible;
